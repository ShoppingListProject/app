...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col backdrop-blur-md">
      <NavBar/>
      <main className='flex flex-col items-start justify-center p-20 lg:pr-40 lg:pl-40'>
        <div>
        ...
        <div className='flex flex-col sm:flex-row w-full justify-center items-center gap-5 md:gap-20 mt-10'>
