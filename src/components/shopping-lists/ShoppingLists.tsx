          ...
          <div className="flex flex-col justify-center mt-5 gap-5">
            ...
            <div className="shadow-lg rounded-lg grow border">
              ...
              <table>
                  ...
                  <tbody>
                    <tr>
                      <td className="p-2 text-center">Weekend Shopping</td>
                      <td className="p-2 text-center">2023-10-01</td>
                      <td className="p-2 text-center align-middle">
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                          <button className="bg-blue-300 p-1 rounded hover:bg-blue-400 block">
                            <span className="hidden sm:inline">Show</span>
                            <EyeIcon className="h-5 w-5 sm:hidden" />
                          </button>
                          <button className="bg-red-300 p-1 rounded hover:bg-red-400 block">
